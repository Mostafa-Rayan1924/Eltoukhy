...
export const metadata = {
  ...
  keywords:
    "Altoukhy, الطوخي, company profile, glass industry, glass supply, glass installation, شركة زجاج, أعمال زجاج, مشاريع زجاجية, تقديم خدمات الزجاج, زجاج عالي الجودة, الابتكار في الزجاج",
};
