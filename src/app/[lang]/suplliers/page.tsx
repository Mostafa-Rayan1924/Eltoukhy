...
export const metadata = {
  ...
  keywords:
    "Altoukhy,الطوخي , local suppliers, global suppliers, glass suppliers, trusted suppliers, glass materials, premium glass products, glass supply chain, موردين محليين, موردين عالميين, مواد زجاجية, منتجات زجاجية عالية الجودة, التعاون مع الموردين",
};
